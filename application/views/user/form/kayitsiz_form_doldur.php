<div class="span9">
	...
	<form action="{base_url}index.php/pages/kayitsiz_form_kaydet" method="post">
	...
	<?php
			if($soru_turu == 'coktan_secmeli'){
				...
				echo "<input class='span7' name='cevaplar[]' placeholder='Cevabinizi buraya giriniz' type='text'>";
			}

		}
	?>
	<input type="hidden" name="form_id" value="<?php echo $form['form_id']; ?>">
	<br><center><input type="submit" class="btn btn-large btn-primary" value="Formu Tamamla">
</div>
